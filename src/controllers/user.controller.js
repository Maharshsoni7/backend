...
const generateAccessTokenAndRefreshToken = async (userId) => {
    try {
        ...
        throw new ApiError(500, "Somethings went to wrong while generate access and refresh token ")
    }
}
...
const refreshAccessToken = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        let { accessToken, newRefreshToken } = await generateAccessTokenAndRefreshToken(user._id)
        return res
            .status(200)
            .clearCookie('accessToken', accessToken, options)
            .clearCookie('refreshToken', newRefreshToken, options).json(new ApiResponse(200, {
